...
console.log('Launching Chrome (non-persistent)...');
const browser = await chromium.launch({
  headless: false,
  args: ['--disable-blink-features=AutomationControlled', '--user-data-dir=' + tmpProf],
  timeout: 30000,
});
...
// Keep browser open for 2 min
console.log('Browser stays open. Auto-closing in 120s...');
