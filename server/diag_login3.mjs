...
await page.goto("https://item.upload.taobao.com/sell/v2/publish.htm?catId=125242010", { waitUntil: "domcontentloaded", timeout: 60000 }).catch(e => console.log("nav err:", e.message));
console.log("URL:", page.url());

if (page.url().includes("login")) {
  console.log("LOGIN REQUIRED - Edge window is open. Please scan QR code. You have 5 minutes.");
  ...
  try {
    ...
    console.log("Login timed out or failed:", e.message.slice(0, 200));
    await context.close();
    process.exit(1);
  }
}
